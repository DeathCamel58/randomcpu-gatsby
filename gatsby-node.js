...
exports.createPages = async gatsbyUtilities => {
  ...
  if (!posts.length) {
    ...
    // If there are posts, create pages for them
    await createIndividualBlogPagePages({ pages, gatsbyUtilities })
 ...
 */
const createIndividualBlogPagePages = async ({ pages, gatsbyUtilities }) =>
    Promise.all(
 ...
 * All WordPress blog posts. If there are any GraphQL errors it throws an error
...
/**
 * This function queries Gatsby's GraphQL server and asks for
 * All WordPress blog pages. If there are any GraphQL errors it throws an error
